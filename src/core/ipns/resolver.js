...
class IpnsResolver {
  ...
  async _resolveName (name) {
    ...
    try {
      ...
      throw errcode(new Error(`record requested was not found for ${name} (${routingKey}) in the network`), 'ERR_NO_RECORD_FOUND')
    }
    ...
    try {
      ...
      throw errcode(new Error(`public key requested was not found for ${name} (${routingPubKey}) in the network`), 'ERR_NO_RECORD_FOUND')
    }
